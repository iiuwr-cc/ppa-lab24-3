...
instruction_statement:
    | lvalue OP_ASSIGN arith_expression
    { STMT_Assign {loc=mkLoc $startpos; lhs=$1; rhs=$3}}

    | lvalue OP_ASSIGN MALLOC
    { STMT_Malloc {loc=mkLoc $startpos; lhs=$1}}
...
simple_struct_statement:
    | lvalue OP_ASSIGN arith_expression SEMICOLON
    { SSTMT_Assign {loc=mkLoc $startpos; lhs=$1; rhs=$3}}

    | lvalue OP_ASSIGN MALLOC SEMICOLON
    { SSTMT_Malloc {loc=mkLoc $startpos; lhs=$1}}
